...
class AzureProductEnclave extends React.Component {
  constructor(props) {
    super(props);
    this.state = {
      activeTab: 0,
      ...
      return (
        <div className="catalogue-right-container">
          ...
          <div className="contents">
            <strong>
              Create new Product Enclave with DevSecOps best practice in Azure
            </strong>
            ...
            <p>
              ...
              deploy your application to Azure, with a series of prompts
            </p>
...
export default AzureProductEnclave;
