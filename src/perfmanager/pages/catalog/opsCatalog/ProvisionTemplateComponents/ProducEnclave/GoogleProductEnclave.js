...
class GoogleProductEnclave extends React.Component {
  constructor(props) {
    super(props);
    this.state = {
      activeTab: 0,
      ...
      return (
        <div className="catalogue-right-container">
          ...
          <div className="contents">
            <strong>
              Create new Product Enclave with DevSecOps best practice in Google
            </strong>
            ...
            <h3>Prerequisites</h3>
            <p>
              <strong>Product Enclave:</strong> The command will package and
              deploy your application to Google, with a series of prompts
            </p>
      ...
      return (
        <div className="catalogue-right-container">
          ...
          <div className="contents">
            <strong>
              {" "}
              Create new Product Enclave with DevSecOps practice in Google
            </strong>
            <h3>Product Enclave</h3>
            <p>
              The command will package and deploy your application to Google,
            ...
            <div className="form-detail-group">
              ...
              <div className="form-group">
                ...
                {errorData && !errorData.isValid && (
                  <span className="error">{errorData.webACLName.message}</span>
                )}
              </div>
              <div className="form-group">
                ...
                />
                {errorData && !errorData.isValid && (
                  <span className="error">{errorData.vpcName.message}</span>
                )}
              </div>
              <div className="form-group">
                ...
                />
                {errorData && !errorData.isValid && (
                  <span className="error">{errorData.vpcCIDR.message}</span>
                )}
              </div>
              <div className="form-group">
                ...
                {errorData && !errorData.isValid && (
                  <span className="error">
                    {errorData.privateSubnetCIDRBlocks.message}
                  </span>
                )}
              </div>
              <div className="form-group">
                ...
                {errorData && !errorData.isValid && (
                  <span className="error">
                    {errorData.publicSubnetCIDRBlocks.message}
                  </span>
                )}
              </div>
              <div className="form-group">
                ...
                {errorData && !errorData.isValid && (
                  <span className="error">
                    {errorData.apiGatewayName.message}
                  </span>
                )}
              </div>
            </div>
...
export default GoogleProductEnclave;
