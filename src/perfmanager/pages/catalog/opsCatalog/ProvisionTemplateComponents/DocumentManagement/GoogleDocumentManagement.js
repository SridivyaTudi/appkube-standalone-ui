...
class GoogleDocumentManagement extends React.Component {
  constructor(props) {
    super(props);
    this.state = {
      activeTab: 0,
      ...
      return (
        <div className="catalogue-right-container">
          ...
          <div className="contents">
            <strong>
              Document Management System with DevSecOps best practice in Google
            </strong>
          ...
          <div className="contents">
            ...
            <div className="form-detail-group">
              ...
              <div className="form-group">
                ...
                />
                {errorData && !errorData.isValid && (
                  <span className="error">{errorData.awsRegion.message}</span>
                )}
              </div>
              <div className="form-group">
...
export default GoogleDocumentManagement;
