...
class GoogleLandingZone extends React.Component {
  constructor(props) {
    super(props);
    this.state = {
      activeTab: 0,
      ...
      return (
        <div className="catalogue-right-container">
          ...
          <div className="contents">
            <strong>
              Create new landing zone with DevSecOps best practice in Google
            </strong>
            <h3>Landing Zone</h3>
            <p>
            ...
            <h3>Prerequisites</h3>
            <p>
              <strong>Landing Zone:</strong> The command will package and deploy
              your application to Google, with a series of prompts
            </p>
      ...
      return (
        <div className="catalogue-right-container">
          ...
          <div className="contents">
            <strong>
              {" "}
              Create new landing zone with DevSecOps practice in Google
            </strong>
            <h3>Landing Zone</h3>
            <p>
              The command will package and deploy your application to Google,
              ...
              <div className="form-group">
                ...
                {errorData && !errorData.isValid && (
                  <span className="error">
                    {errorData.ctManagementAccountId.message}
                  </span>
                )}
              </div>
              <div className="form-group">
                ...
                {errorData && !errorData.isValid && (
                  <span className="error">
                    {errorData.logArchiveAccountId.message}
                  </span>
                )}
              </div>
              <div className="form-group">
                ...
                {errorData && !errorData.isValid && (
                  <span className="error">
                    {errorData.auditAccountId.message}
                  </span>
                )}
              </div>
              <div className="form-group">
                ...
                {errorData && !errorData.isValid && (
                  <span className="error">
                    {errorData.aftManagementAccountId.message}
                  </span>
                )}
              </div>
              <div className="form-group">
                ...
                {errorData && !errorData.isValid && (
                  <span className="error">
                    {errorData.gitHubUsername.message}
                  </span>
                )}
              </div>
              <div className="form-group">
                ...
                {errorData && !errorData.isValid && (
                  <span className="error">
                    {errorData.ctHomeRegion.message}
                  </span>
                )}
              </div>
              <div className="form-group">
                ...
                {errorData && !errorData.isValid && (
                  <span className="error">
                    {errorData.tfBackendSecondaryRegion.message}
                  </span>
                )}
              </div>
            </div>
...
export default GoogleLandingZone;
