        ...
        <div className="alert-page-container">
            ...
            <div className="row">
              ...
              <div className="col-md-7 col-sm-12">
                <div className="float-right common-right-btn">
                  <button className="alert-blue-button save-rule">Save Rule</button>
          ...
          <div className="common-container wizard-container">
            ...
            <div className="d-block width-100 text-right alert-wizard-buttons">
              {!state.hidePrevBtn && (
                <button className="alert-blue-button m-r-0 m-b-0 previous-btn" onClick={this.onClickPrevious}>
                  Previous
                </button>
              )}
              {!state.hideNextBtn && (
                <button className="alert-blue-button m-r-0 m-b-0 next-btn" onClick={this.onClickNext}>
                  Next
                </button>
              )}
              {!state.hideFinishBtn && <button className="alert-blue-button m-r-0 m-b-0 finish-btn">Finish</button>}
            </div>
          </div>
        </div>
      </div>
