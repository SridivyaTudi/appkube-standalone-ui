...
class ComplianceHistory extends React.Component {
  constructor(props) {
    super(props);
    this.state = {
      searchKey: "",
  ...
  onSearchChange = (e) => {
    ...
    for (let i = 0; i < duplicateHistoryData.length; i++) {
      if (
        duplicateHistoryData[i].mainTitle.indexOf(value) !== -1 ||
        value === ""
      ) {
        searchResult.push(duplicateHistoryData[i]);
      } else if (
        duplicateHistoryData[i].mainTitle.toLowerCase().indexOf(value) !== -1 ||
        value === ""
      ) {
        searchResult.push(duplicateHistoryData[i]);
      }
                ...
                <div className="row">
                  <div className="col-lg-10 col-md-9 col-sm-12">
                    ...
                    <p className="d-block width-100">
                      I am should have creadentialReportGeneratedTime after
                      (-24, 'hours')
                    </p>
                    <div className="d-block width-100 tasted-boxes">
                      ...
                      <div className="d-inline-block p-r-5 tasted-box">
                        <span className="d-inline-block non-complaint">1</span>{" "}
                        {data.step3}
                      </div>
                    </div>
            ...
            <div className="d-block heading">
              <div className="row">
                <div className="col-lg-6 col-md-6 col-sm-12">
                  <h2>
                    <strong>RESULTS</strong> ( Ruleset: AWS CCP Framework,
                    Account: AWS | Mumbai )
                  </h2>
            ...
            <div className="d-block p-t-20">
              <div className="d-inline-block results-left-chart">
                <div className="d-inline-block chart-box">
                  ...
                  <div className="d-block chart-inner">
                    <div className="text-center progress-text">
                      {now}% 4/12 passed tests (5 excluded)
                    </div>
                ...
                <div className="d-inline-block chart-box">
                  ...
                  <div className="d-block chart-inner">
                    <Pie
                      data={{ datasets: singleChartdata, labels: singleLabels }}
                ...
                <div className="d-inline-block chart-box green-chart">
                  ...
                  <div className="d-block chart-inner">
                    <Bar
                      data={{ datasets: barData, labels: barLabels }}
                ...
                <div className="d-inline-block chart-box">
                  ...
                  <div className="d-block chart-inner">
                    <Pie
                      data={{ datasets: pieData, labels: pieLabels }}
                      options={this.pieOptions}
                    />
                  </div>
                </div>
              ...
              <div className="col-lg-9 col-md-12 col-sm-12">
                ...
                <div className="form-group filter-control-group">
                  ...
                  <select className="form-control" id="ComplianceSection">
                    <option value="selectComplianceSection">
