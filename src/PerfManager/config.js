...
export const config = {
  ...
  ADD_COLLECTOR_TO_LIBRARY_SUCCESS_MESSAGE: 'Collector is successfully added to library',
  ADD_DASHBOARD_TO_COLLECTOR: `${catalogSrvUrl}/addDashboardToCollector`,
  ADD_DASHBOARD_TO_COLLECTOR_SUCCESS_MESSAGE: 'Dashborad is successfully added to collector',
