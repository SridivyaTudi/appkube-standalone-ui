      ...
      return (
        <div className="catalogue-right-container">
          ...
          <div className="contents">
            <strong>
              Document Management System with DevSecOps best practice in AWS
            </strong>
            ...
            <p>
              <strong>AWS Region:</strong> The AWS region you want to deploy
              your app to use
            </p>
            <p>
            ...
            <p>
              ...
              review; if set to no, the AWS SAM CLI will automatically deploy
              application changes
            </p>
            <p>
              <strong>Allow SAM CLI IAM role creation:</strong> FormKiQ Core’s
              AWS SAM templates create AWS IAM roles required for the AWS Lambda
              function(s) included to access AWS services; the permissions are
              passed in by the sam deploy command above, so this value should be
              set to "Y"{" "}
            </p>
            <p>
      ...
      return (
        <div className="catalogue-right-container">
          ...
          <div className="contents">
            ...
            <h3>Document Management System</h3>
            <p>
              This Command will package and deploy your application to AWS, with
              a series of prompts
            </p>
...
export default AwsDocumentManagement;
