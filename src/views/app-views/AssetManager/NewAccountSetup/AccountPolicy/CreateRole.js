          ...
          >
            <Grid item xs={7}>
              <div className="create-role-border">
                ...
                <ul>
                  <li>
                    <span>1.</span> in the <strong>Access Management menu, Select Roles</strong> and
                    Click <strong>Create Role</strong>
                  </li>
                  <li>
                    <span>2.</span> in the <strong>Select Trusted Entity</strong> Window, Select{" "}
                  ...
                  <li>
                    <span>4.</span> Under Option, Select the <strong>Required External ID</strong>{" "}
                    and Enter the{" "}
                    <strong>External ID: ME4@s7fv@sQsghDvsea4RE</strong>
                  </li>
                  <li><span>5.</span> Make Sure Not To Select Require MFA</li>
                  <li>
                    <span>6.</span> Select The Following: <strong>'SecurityAudit'</strong> (AWS
                    managed policy) <strong>'Appkube-readonly-policy'</strong> that
                    we created before. you can sea Appkube in the filter
                  </li>
                  <li>
                    <span>7.</span> Click on the <strong>'Next'</strong> button at the bottom of the
                    page
                  </li>
                  <li>
                  ...
                  <li>
                    <span>9.</span> On the search box look for the 'Role name' you set in the
                    previous step, and click on it
                  </li>
                  <li>
                    <span>10.</span> Copy the <strong>Role ARN</strong> and fill it in the Role ARN
                    field
                  </li>
                </ul>
              </div>
            ...
            <Grid item xs={5}>
              <div className="account-setup-right-contents">
                ...
                <div className="form-group">
                  ...
                  <span className="red"> {(!this.state.name && !this.state.role && !this.state.externalId) || this.props.validateRoleFlag.initialMsgFlag ? this.props.validateRoleFlag.role ? 'Role ARN is required' : '' : this.state.role == '' && this.props.validateRoleFlag.role ? 'Role ARN is required' : ""}</span>
                </div>
                <div className="form-group">
                  ...
                  />
                  <span className="red">{(!this.state.name && !this.state.role && !this.state.externalId) || this.props.validateRoleFlag.initialMsgFlag ? this.props.validateRoleFlag.externalId ? 'External ID is required' : '' : this.state.externalId == '' && this.props.validateRoleFlag.externalId ? 'External ID is required' : ""}  </span>
