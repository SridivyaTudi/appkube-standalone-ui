...
class ProductWiseServicesSla extends Component {
  constructor(props) {
    super(props);
    this.state = {
      chartData: [],
  ...
  getServicesData = async () => {
    try {
      await RestService.getData(`${this.config.GET_SERVICES_DATA}`, null, null).then((response) => {
              ...
              if (servicesArray && servicesArray.length > 0) {
                ...
                for (let k = 0; k < servicesArray.length; k++) {
                  ...
                  if (sla_json) {
                    ...
                    serviceByType['compliance'] = serviceByType['compliance'] + (compliance ? compliance['sla'] : 0);
                  ...
                  <div className="row">
                    <div className="col-lg-9 col-md-9 col-sm-12" style={{ marginBottom: '10px' }}>
                      <div className="topology-heading">
                        ...
                        >
                          <img src={Jobs} alt="" style={{ maxWidth: '15px' }} />
                        </div>
                      </div>
                    </div>
                    {isTopologyActive ? (
