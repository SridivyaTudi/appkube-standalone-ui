      ...
      <div className="d-inline-block width-100 account-setup-tab-contents">
        <div className="contents">
          <strong style={{ paddingBottom: "20px" }}>
            Prepare IAM Policy for Synectiks Monitoring
          </strong>
          <p>
            ...
            Name the policy ‘Synectiks Monitoring-readonly-policy’ and click on
            ‘Create Policy’ <br />
            Click again on ‘Create Policy’ button <br />
            Select the ‘JSON’ tab <br />
            Copy and paste in this <a>policy document</a>
            <br />
            Name the policy ‘Synectiks Monitoring-write-policy’ and click on
            ‘Create Policy’ <br />
            Click on ‘<a>NEXT</a>‘
          </p>
        </div>
