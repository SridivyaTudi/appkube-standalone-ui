...
export default class QryUtils {
  ...
  static extractEntityArray(entKeys, arr, forRctTbl, key, visitNested = true) {
    ...
    arr.forEach((item) => {
      if (visitNested && Array.isArray(item)) {
        ...
        entKeys = QryUtils.visitEntityForKeys(
          entKeys,
          item,
          visitNested,
          forRctTbl,
