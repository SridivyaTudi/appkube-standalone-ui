                ...
                <div className="heading-content-left">
                  ...
                  <div className="heading-content">
                    ...
                    <p>
                      ...
                      sed do eiusmod tempor incididunt ut laboreet dolore magna
                      aliqua. Ut enim ad minim, quis nostrud exercitation
                ...
                <div className="tbody">
                  {useCaseList &&
                    useCaseList.map((useCase, index) => {
                      let checkList = useCase?.stepinput
                        ? useCase.stepinput
                        : "";
                          ...
                          <div className="tr" key={`usecase-${index}`}>
                            ...
                            {checkList.stages && checkList.stages.length > 0 ? (
                              checkList.stages.map((list, index) => {
                                let statusclass = list.workflowCheckList
                                  ? this.checkStatusOfWorkflow(
                                      list.workflowCheckList
                                    )
                                  : this.checkStatusOfWorkflow(
                                      list.workflowCheckList
                                    );
