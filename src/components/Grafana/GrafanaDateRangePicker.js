...
class GrafanaDateRangePicker extends Component {
  ...
  render() {
    ...
    const {
      startDate, endDate, liveTail, refresh,
    } = this.props;
    return (
      <NoSsr>
        <React.Fragment>
                ...
                <Grid container>
                  <Grid item xs={12} >
                    ...
                    <div>
                      ...
                      <MesheryDateTimePicker disabled={liveTail} selectedDate={endDate} onChange={this.handleChange('endDate')} label="End" />
                    </div>
                    <div>
                      <FormControlLabel
                        control={(
                  ...
                  <Grid item xs={12}>
                    ...
                    <Grid container spacing={0}>
                      {quickRanges.map((qr) => (
                        <Grid item key={qr.uniqueID} xs={12} sm={3}>
                          {qr.map((q) => (
