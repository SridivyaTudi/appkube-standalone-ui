        ...
        <Grid container alignItems={"center"}  rowSpacing={1} columnSpacing={{ xs: 1, sm: 2, md: 3 }}>
          ...
          <Grid item xs={4}>
            <Box className="following-ports">
              <Box className="following-title">The following ports are opened by default:</Box>
              <List>
                <ListItem>80, 8080, 8686 - proxies HTTP traffic to HTTP (80 port)</ListItem>
                <ListItem>4848, 8443, 4901-4910 - proxies SSL (HTTPS) traffic is proxied to SSL</ListItem>
                <ListItem>443 - proxies SSL traffic is proxied to HTTP (80 port)</ListItem>
