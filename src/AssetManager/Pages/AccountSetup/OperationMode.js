    ...
    return (
      <div className="d-inline-block width-100 account-setup-tab-contents">
        ...
        <div className="contents">
          ...
          <p>
            In the Full-Protection(Read/Write) Mode, CloudGuard can be used to
            actively manage your security posture and enforce best practices.
          </p>
        </div>
        <div className="contents">
        ...
        <div className="contents">
          ...
          <ul>
            <li>
              You want to use Synectiks Monitoring as your system of authority
              for security management
            </li>
            <li>
              You want to use Synectiks Monitoring active management and
              enforcement capabilities to maintain a closed-by-default security
              posture
            </li>
          </ul>
        </div>
        <div className="contents">
          <p>
            Note that even when you are using Synectiks Monitoring
            Full-Protection (Read/Write) Mode you'll still be able to set
            individual security groups to Monitor (Read-Only) Mode
          </p>
        </div>
      </div>
    );
