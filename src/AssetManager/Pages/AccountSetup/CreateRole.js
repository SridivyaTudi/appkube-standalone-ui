            ...
            <div className="account-setup-left-contents">
              <div className="contents">
                <strong style={{ paddingBottom: "20px" }}>
                  Create IAM user for Synectiks Monitoring
                </strong>
                <p>
                  Login to AWS console (<a>aws.amazon.com</a>)<br />
                  Click ‘<strong>Services</strong>‘ on the top and ‘
                  <strong>IAM</strong>‘ in the dropdown.
                  <br />
                  Click ‘users‘ on the left pane
                  <br />
                  Create New User: '<strong>Synectiks Monitoring</strong>', make
                  sure to provide programmatic access only
                  <br />
                ...
                <ul>
                  ...
                  <li>
                    ‘Synectiks Monitoring-readonly-policy’ That we created
                    before. You can search for
                  </li>
                  <li>‘Synectiks Monitoring’ in the filter</li>
                  <li>
                    ‘Synectiks Monitoring-write-policy’ That we created before
                  </li>
                </ul>
                <p>
                  Click on the ‘<strong>Next: Review</strong>‘ button
                  <br />
                  Verify you selected only programmatic access, then click on{" "}
                  <strong>Create User</strong>
                  <br />
                  Enter the values of "Access key ID" and the "Secret access
                  key" in the right text boxes
                  <br />
                  (save the secret key, you may need it in the future)
                  <br />
                  Click on <a>NEXT</a>
                </p>
              </div>
